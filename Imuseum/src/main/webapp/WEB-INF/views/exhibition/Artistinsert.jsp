							...
							<table style="width: 100%;">
								<tr>
									...
									<td width="35%" style="padding: 0 20px;">
										<input type="text" id="exhName" value="${vo.exhName}" readonly="readonly" required>
									</td>
									<th width="15%">작가명</th>
									<td width="35%"><input type="text" placeholder="작가명을 입력하세요." name="artist" id="artist" required></td>
								</tr>
								<tr>
									<th>대표이미지</th>
									<td style="height: 100%;">
